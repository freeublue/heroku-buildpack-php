...
<html lang="en">
  <head>
    ...
    <meta name="description" content="fast, Laundry service. collected and delivered">
...
if (xc==null || xc=="")
  ...
  <body>
    ...
    <div class="container">
      ...
      <form name='rform' onsubmit='return validateForm();' action='cinlog.php' method='post' class="form-signin">
